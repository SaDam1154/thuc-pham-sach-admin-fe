...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
    this.databaseId = t, this.an = new __PRIVATE_MemoryCollectionParentIndex(), this.un = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  addToCollectionParentIndex(e, t) {
    if (!this.an.has(t)) {
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  constructor(e, t) {
    super(), this.ar = e, this.trackRemovals = t, this.ur = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
  ...
  getAllFromCache(e, t) {
    return this.ar.sr(e, t).next(({ documents: e2, _r: t2 }) => (t2.forEach((t3, n) => {
      this.ur.set(t3, {
        size: n,
...
var __PRIVATE_IndexedDbPersistence = class {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 16) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.oi = i, this.window = s, this.document = o, this._i = a, this.ai = u, this.ui = c, this.kr = null, this.qr = false, this.isPrimary = false, this.networkEnabled = true, this.ci = null, this.inForeground = false, this.li = null, this.hi = null, this.Pi = Number.NEGATIVE_INFINITY, this.Ii = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.D())
  ...
  async shutdown() {
    this.qr = false, this.xi(), this.hi && (this.hi.cancel(), this.hi = null), this.Oi(), this.Ni(), await this.Ei.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
  ...
  Vi() {
    ...
    "function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.ci = () => {
      ...
      isSafari() && (navigator.appVersion.match(e2) || navigator.userAgent.match(e2)) && this.oi.enterRestrictedMode(true), this.oi.enqueueAndForget(() => this.shutdown());
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r) {
    this.persistence = e, this.ts = t, this.serializer = r, this.ns = new SortedMap(__PRIVATE_primitiveComparator), this.rs = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.ss = /* @__PURE__ */ new Map(), this.os = e.getRemoteDocumentCache(), this.Qr = e.getTargetCache(), this.$r = e.getBundleCache(), this._s(n);
  }
  _s(e) {
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.oi = t, this.persistenceKey = n, this.Vs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.fs = this.gs.bind(this), this.ps = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.ys = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.ws = createWebStorageClientStateKey(this.persistenceKey, this.Vs), this.Ss = function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.ps = this.ps.insert(this.Vs, new __PRIVATE_LocalClientState()), this.bs = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.Ds = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.Cs = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.vs = function createWebStorageOnlineStateKey(e2) {
  ...
  async start() {
    ...
    for (const e2 of this.ys)
      this.gs(e2);
    this.ys = [], this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = C.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P.po(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  D_(e) {
    "Online" === this.state ? this.S_("Unknown") : (this.g_++, this.g_ >= 1 && (this.C_(), this.b_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.S_("Offline")));
  }
  set(e) {
    this.C_(), this.g_ = 0, "Online" === e && (this.y_ = false), this.S_(e);
  }
  S_(e) {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.v_ = [], this.F_ = /* @__PURE__ */ new Map(), this.M_ = /* @__PURE__ */ new Set(), this.x_ = [], this.O_ = i, this.O_.io((e2) => {
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.F_.delete(t), r.Xo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.F_.size && (r.Xo() ? r.n_() : __PRIVATE_canUseNetwork(n) && n.N_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.N_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
  ...
  if (s) {
    ...
    e2 >= 0 && (s.U_.splice(e2, 1), 0 === s.U_.length ? i = t.G_() ? 0 : 1 : !s.W_() && t.G_() && (i = 2));
  }
  switch (i) {
    case 0:
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.oa = e, this.localStore = t, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
  }
  _a(e) {
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Sa = {}, this.ba = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Da = /* @__PURE__ */ new Map(), this.Ca = /* @__PURE__ */ new Set(), this.va = new SortedMap(DocumentKey.comparator), this.Fa = /* @__PURE__ */ new Map(), this.Ma = new __PRIVATE_ReferenceSet(), this.xa = {}, this.Oa = /* @__PURE__ */ new Map(), this.Na = __PRIVATE_TargetIdGenerator.Ln(), this.onlineState = "Unknown", this.La = void 0;
  }
  get isPrimaryClient() {
    return true === this.La;
  }
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
  ...
  let i;
  const s = r.ba.get(t);
  return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.ya()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
    r,
    t,
    n,
    true
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.Ba = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
    ...
    i2.Xi && (i2 = await __PRIVATE_localStoreExecuteQuery(
      e2.localStore,
      t3.query,
      false
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.La) {
    ...
    for (const e2 of n)
      r.Da.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.Qa.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Qa.syncEngine), await __PRIVATE_fillWritePipeline(this.Qa.remoteStore), await this.persistence.fi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  async initialize(e) {
    ...
    }, await this.sharedClientState.start()), await this.persistence.fi(async (e2) => {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.Ua = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Wa = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Za = n.maxAttempts, this.Yo = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  Xa() {
    this.Za -= 1, this.eu();
  }
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(true), function __PRIVATE_remoteStoreEnableNetwork(e2) {
      ...
      return t2.M_.delete(0), __PRIVATE_enableNetworkInternal(t2);
    }(n);
  });
}
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.M_.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.N_.set("Offline");
    }(n);
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).z_.add(t2), t2.next();
...
var __PRIVATE_ParseContextImpl = class {
  constructor(e, t, n, r, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r, void 0 === i && this.mu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
