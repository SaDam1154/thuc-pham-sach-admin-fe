...
var LinesEllipsis = class extends import_react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      text: props.text,
  ...
  render() {
    ...
    }, omit(rest, usedProps)), clamped && trimRight ? text.replace(/[\s\uFEFF\xA0]+$/, "") : text, import_react.default.createElement("wbr", null), clamped && import_react.default.createElement("span", {
...
export {
  LinesEllipsis as default
};
//# sourceMappingURL=react-lines-ellipsis.js.map
