...
var require_lib = __commonJS({
  "node_modules/react-to-print/lib/index.js"(exports, module) {
    !function(e, t) {
      ...
      return function() {
        "use strict";
        var n = { 655: function(e2, t2, n2) {
          n2.r(t2), n2.d(t2, { __extends: function() {
            return o2;
          }, __assign: function() {
            return i2;
          }, __rest: function() {
          ...
          function l(e3, t3, n3, r3) {
            ...
            if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
              ...
              for (var l2 = e3.length - 1; l2 >= 0; l2--)
                (o3 = e3[l2]) && (a2 = (i3 < 3 ? o3(a2) : i3 > 3 ? o3(t3, n3, a2) : o3(t3, n3)) || a2);
          ...
          function f(e3, t3) {
            ...
            return i3 = { next: l2(0), throw: l2(1), return: l2(2) }, "function" == typeof Symbol && (i3[Symbol.iterator] = function() {
              return this;
            }), i3;
            function l2(l3) {
              return function(c2) {
                return function(l4) {
                  ...
                  for (; i3 && (i3 = 0, l4[0] && (a2 = 0)), a2; )
                    try {
                      if (n3 = 1, r3 && (o3 = 2 & l4[0] ? r3.return : l4[0] ? r3.throw || ((o3 = r3.return) && o3.call(r3), 0) : r3.next) && !(o3 = o3.call(r3, l4[1])).done)
                        return o3;
                      switch (r3 = 0, o3 && (l4 = [2 & l4[0], o3.value]), l4[0]) {
                        case 0:
                        case 1:
                          o3 = l4;
                          break;
                        ...
                        case 5:
                          a2.label++, r3 = l4[1], l4 = [0];
                          continue;
                        case 7:
                          l4 = a2.ops.pop(), a2.trys.pop();
                          continue;
                        default:
                          if (!((o3 = (o3 = a2.trys).length > 0 && o3[o3.length - 1]) || 6 !== l4[0] && 2 !== l4[0])) {
                            a2 = 0;
                            continue;
                          }
                          if (3 === l4[0] && (!o3 || l4[1] > o3[0] && l4[1] < o3[3])) {
                            a2.label = l4[1];
                            break;
                          }
                          if (6 === l4[0] && a2.label < o3[1]) {
                            a2.label = o3[1], o3 = l4;
                            break;
                          }
                          if (o3 && a2.label < o3[2]) {
                            a2.label = o3[2], a2.ops.push(l4);
                            break;
                          }
          ...
          var d = Object.create ? function(e3, t3, n3, r3) {
            void 0 === r3 && (r3 = n3);
          ...
          function p(e3, t3) {
            for (var n3 in e3)
              "default" === n3 || Object.prototype.hasOwnProperty.call(t3, n3) || d(t3, e3, n3);
          }
          function h(e3) {
          ...
          function g() {
            ...
            for (t3 = 0; t3 < n3; t3++)
              for (var i3 = arguments[t3], a2 = 0, l2 = i3.length; a2 < l2; a2++, o3++)
                r3[o3] = i3[a2];
            return r3;
          }
          function m(e3, t3, n3) {
          ...
          function v(e3) {
            return this instanceof v ? (this.v = e3, this) : new v(e3);
          }
          function w(e3, t3, n3) {
            ...
            function a2(e4) {
              o3[e4] && (r3[e4] = function(t4) {
                return new Promise(function(n4, r4) {
                  i3.push([e4, t4, n4, r4]) > 1 || l2(e4, t4);
                });
              });
            }
            function l2(e4, t4) {
              try {
                (n4 = o3[e4](t4)).value instanceof v ? Promise.resolve(n4.value.v).then(c2, u2) : s2(i3[0][2], n4);
              } catch (e5) {
                s2(i3[0][3], e5);
              }
              var n4;
            ...
            function s2(e4, t4) {
              e4(t4), i3.shift(), i3.length && l2(i3[0][0], i3[0][1]);
            }
          }
          function _(e3) {
            var t3, n3;
            ...
            function r3(r4, o3) {
              t3[r4] = e3[r4] ? function(t4) {
                return (n3 = !n3) ? { value: v(e3[r4](t4)), done: "return" === r4 } : o3 ? o3(t4) : t4;
              } : o3;
            }
          }
          function P(e3) {
            ...
            return n3 ? n3.call(e3) : (e3 = h(e3), t3 = {}, r3("next"), r3("throw"), r3("return"), t3[Symbol.asyncIterator] = function() {
              return this;
            }, t3);
            function r3(n4) {
          ...
          var S = Object.create ? function(e3, t3) {
          ...
          function x(e3) {
            ...
            if (null != e3)
              for (var n3 in e3)
                "default" !== n3 && Object.prototype.hasOwnProperty.call(e3, n3) && d(t3, e3, n3);
            return S(t3, e3), t3;
          }
          function E(e3) {
        ...
        return function() {
          ...
          var t2 = o(655), n2 = o(156), r2 = o(111), a = Object.prototype.hasOwnProperty.call(n2, "createContext"), l = Object.prototype.hasOwnProperty.call(n2, "useMemo") && Object.prototype.hasOwnProperty.call(n2, "useCallback"), c = a ? n2.createContext({}) : null;
          e2.PrintContextConsumer = c ? c.Consumer : function() {
            return null;
          };
          var u = { copyStyles: true, pageStyle: "@page { size: auto;  margin: 0mm; } @media print { body { -webkit-print-color-adjust: exact; } }", removeAfterPrint: false, suppressErrors: false }, s = function(e3) {
            function o2() {
              ...
              return n3.startPrint = function(e4) {
                ...
                setTimeout(function() {
                  ...
                  if (e4.contentWindow) {
                    if (e4.contentWindow.focus(), i2)
                      i2(e4).then(n3.handleRemoveIframe).catch(function(e5) {
                        o3 ? o3("print", e5) : n3.logMessages(["An error was thrown by the specified `print` function"]);
                      });
                    else if (e4.contentWindow.print) {
                      var c2 = null !== (l2 = null === (t4 = e4.contentDocument) || void 0 === t4 ? void 0 : t4.title) && void 0 !== l2 ? l2 : "", u2 = e4.ownerDocument.title;
                      a2 && (e4.ownerDocument.title = a2, e4.contentDocument && (e4.contentDocument.title = a2)), e4.contentWindow.print(), a2 && (e4.ownerDocument.title = u2, e4.contentDocument && (e4.contentDocument.title = c2));
                    } else
                ...
                var e4 = n3.props, o3 = e4.bodyClass, i2 = e4.content, a2 = e4.copyStyles, l2 = e4.fonts, c2 = e4.pageStyle, u2 = e4.nonce, s2 = i2();
                if (void 0 !== s2)
                  if (null !== s2) {
                    ...
                    if (d) {
                      var p = d.cloneNode(true), h = p instanceof Text, y = document.querySelectorAll("link[rel='stylesheet']"), b = h ? [] : p.querySelectorAll("img"), g = h ? [] : p.querySelectorAll("video");
                      n3.linkTotal = y.length + b.length + g.length, n3.linksLoaded = [], n3.linksErrored = [], n3.fontsLoaded = [], n3.fontsErrored = [];
                      var m = function(e5, t3) {
                        t3 ? n3.linksLoaded.push(e5) : (n3.logMessages(['"react-to-print" was unable to load a linked node. It may be invalid. "react-to-print" will continue attempting to print the page. The linked node that errored was:', e5]), n3.linksErrored.push(e5)), n3.linksLoaded.length + n3.linksErrored.length + n3.fontsLoaded.length + n3.fontsErrored.length === n3.linkTotal && n3.triggerPrint(f);
                      };
                      f.onload = function() {
                        var e5, r3, i3, s3;
                        f.onload = null;
                        ...
                        if (y2) {
                          y2.body.appendChild(p), l2 && ((null === (i3 = f.contentDocument) || void 0 === i3 ? void 0 : i3.fonts) && (null === (s3 = f.contentWindow) || void 0 === s3 ? void 0 : s3.FontFace) ? l2.forEach(function(e6) {
                            var t3 = new FontFace(e6.family, e6.source);
                            f.contentDocument.fonts.add(t3), t3.loaded.then(function(e7) {
                              n3.fontsLoaded.push(e7);
                            }).catch(function(e7) {
                              n3.fontsErrored.push(t3), n3.logMessages(['"react-to-print" was unable to load a font. "react-to-print" will continue attempting to print the page. The font that failed to load is:', t3, "The error from loading the font is:", e7]);
                            });
                          }) : n3.logMessages(['"react-to-print" is not able to load custom fonts because the browser does not support the FontFace API']));
                          var v = "function" == typeof c2 ? c2() : c2;
                          if ("string" != typeof v)
                            n3.logMessages(['"react-to-print" expected a "string" from `pageStyle` but received "'.concat(typeof v, '". Styles from `pageStyle` will not be applied.')]);
                          else {
                            var w = y2.createElement("style");
                            u2 && (w.setAttribute("nonce", u2), y2.head.setAttribute("nonce", u2)), w.appendChild(y2.createTextNode(v)), y2.head.appendChild(w);
                          }
                          if (o3 && (e5 = y2.body.classList).add.apply(e5, (0, t2.__spreadArray)([], (0, t2.__read)(o3.split(" ")), false)), !h) {
                            for (var _ = h ? [] : d.querySelectorAll("canvas"), P = y2.querySelectorAll("canvas"), O = 0; O < _.length; ++O) {
                              var S = _[O], x = P[O].getContext("2d");
                              x && x.drawImage(S, 0, 0);
                            }
                            for (O = 0; O < b.length; O++) {
                              var E = b[O], T = E.getAttribute("src");
                              T ? ((A = new Image()).onload = m.bind(null, E, true), A.onerror = m.bind(null, E, false), A.src = T) : (n3.logMessages(['"react-to-print" encountered an <img> tag with an empty "src" attribute. It will not attempt to pre-load it. The <img> is:', E], "warning"), m(E, false));
                            }
                            for (O = 0; O < g.length; O++) {
                              var j = g[O];
                              j.preload = "auto";
                              var A, k = j.getAttribute("poster");
                              k ? ((A = new Image()).onload = m.bind(null, j, true), A.onerror = m.bind(null, j, false), A.src = k) : j.readyState >= 2 ? m(j, true) : (j.onloadeddata = m.bind(null, j, true), j.onerror = m.bind(null, j, false), j.onstalled = m.bind(null, j, false));
                            }
                            var C = "input", M = d.querySelectorAll(C), R = y2.querySelectorAll(C);
                            for (O = 0; O < M.length; O++)
                              R[O].value = M[O].value;
                            var I = "input[type=checkbox],input[type=radio]", q = d.querySelectorAll(I), D = y2.querySelectorAll(I);
                            for (O = 0; O < q.length; O++)
                              D[O].checked = q[O].checked;
                            var W = "select", L = d.querySelectorAll(W), F = y2.querySelectorAll(W);
                            for (O = 0; O < L.length; O++)
                              F[O].value = L[O].value;
                          }
                          if (a2)
                            for (var N = document.querySelectorAll("style, link[rel='stylesheet']"), B = (O = 0, N.length); O < B; ++O) {
                              var G = N[O];
                              if ("style" === G.tagName.toLowerCase()) {
                                var H = y2.createElement(G.tagName), Y = G.sheet;
                                if (Y) {
                                  var z = "";
                                  try {
                                    for (var V = Y.cssRules.length, U = 0; U < V; ++U)
                                      "string" == typeof Y.cssRules[U].cssText && (z += "".concat(Y.cssRules[U].cssText, "\r\n"));
                                  } catch (e6) {
                                  ...
                                  H.setAttribute("id", "react-to-print-".concat(O)), u2 && H.setAttribute("nonce", u2), H.appendChild(y2.createTextNode(z)), y2.head.appendChild(H);
                                }
                              } else if (G.getAttribute("href"))
                                if (G.hasAttribute("disabled"))
                                  n3.logMessages(["`react-to-print` encountered a <link> tag with a `disabled` attribute and will ignore it. Note that the `disabled` attribute is deprecated, and some browsers ignore it. You should stop using it. https://developer.mozilla.org/en-US/docs/Web/HTML/Element/link#attr-disabled. The <link> is:", G], "warning"), m(G, true);
                                else {
                                  H = y2.createElement(G.tagName), U = 0;
                                  for (var J = G.attributes.length; U < J; ++U) {
                                    var K = G.attributes[U];
                                    K && H.setAttribute(K.nodeName, K.nodeValue || "");
                                  }
                                  H.onload = m.bind(null, H, true), H.onerror = m.bind(null, H, false), u2 && H.setAttribute("nonce", u2), y2.head.appendChild(H);
                                }
                              else
                                n3.logMessages(["`react-to-print` encountered a <link> tag with an empty `href` attribute. In addition to being invalid HTML, this can cause problems in many browsers, and so the <link> was not loaded. The <link> is:", G], "warning"), m(G, true);
                            }
                        }
                        0 !== n3.linkTotal && a2 || n3.triggerPrint(f);
            ...
            return (0, t2.__extends)(o2, e3), o2.prototype.render = function() {
              ...
              return n2.createElement(c.Provider, { value: o3 }, t3);
          ...
          e2.default = s, e2.useReactToPrint = function(e3) {
            ...
            var r3 = n2.useMemo(function() {
              return new s((0, t2.__assign)((0, t2.__assign)({}, u), e3));
            }, [e3]);
